...
class RegionCityscapes(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image, lbls = self.transform(image, [target, target_precise, superpixel])
        target, target_precise, superpixel = lbls
        ...
        if self.return_spx is False:
            ...
            sample = {'images': image, 'target': target, 'labels': target_precise, 'spx': superpixel, 'fnames': self.im_idx[index]}
        return sample
