...
from .constant import train_id_to_color, id_to_train_id, voc_id_to_color_map
# for synthia
import imageio
...
class RegionVOC(data.Dataset):
    ...
    def __init__(self,
                 ...
                 transform=None,
                 return_spx=False,
                 region_dict="dataloader/init_data/voc/train_seed32.dict",
                 mask_region=True,
        ...
        if datalist is not None:
            ...
            for index, fname in enumerate(valid_list):
                ...
                if self.dominant_labeling:
                    lbl_fullname = os.path.join(self.root, 'superpixels/pascal_voc_seg/seeds_32/train/gtFine_dominant/'+fname[0]+'.png')
                else:
                    lbl_fullname = os.path.join(self.root, 'VOC2012/SegmentationClass/'+fname[0]+'.png')
                # print(lbl_fullname)
                spx_fullname = os.path.join(self.root, 'superpixels/pascal_voc_seg/seeds_32/train/label/'+fname[0]+'.pkl')
    ...
    def decode_target(cls, target):
        ...
        return voc_id_to_color_map[target_] #target_ #train_id_to_color[target_]
