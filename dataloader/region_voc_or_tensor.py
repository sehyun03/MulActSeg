...
class RegionVOCOr(RegionVOC):
    ...
    def __init__(self, args, root, datalist, split='train', transform=None, return_spx=False,
        ...
        if args.nseg == 150: ### change segsize into nseg
            nseg = 32
        elif args.nseg == 600:
            nseg = 16
        else:
        ...
        if args.trim_multihot_boundary:
            ''
            # multi_hot_cls_path = '{}/superpixels/pascal_voc_seg/seeds_{}/train/multihot_trim{}/multi_hot_cls.npy'.format(self.root, nseg, args.trim_kernel_size)
            # sp_size_path = '{}/superpixels/pascal_voc_seg/seeds_{}/train/multihot_trim{}/sp_size.npy'.format(self.root, nseg, args.trim_kernel_size)
            multi_hot_cls_path = '{}/superpixels/pascal_voc_seg/seeds_{}/train/gtFine_multi_tensor_trim_{}x{}/multi_hot_cls.npy'.format(self.root, nseg, args.trim_kernel_size, args.trim_kernel_size)
            sp_size_path = '{}/superpixels/pascal_voc_seg/seeds_{}/train/gtFine_multi_tensor_trim_{}x{}/sp_size.npy'.format(self.root, nseg, args.trim_kernel_size, args.trim_kernel_size)
        else:
            multi_hot_cls_path = '{}/superpixels/pascal_voc_seg/seeds_{}/train/multihot/multi_hot_cls.npy'.format(nseg, self.root)
            sp_size_path = '{}/superpixels/pascal_voc_seg/seeds_{}/train/multihot/sp_size.npy'.format(nseg, self.root)
        ...
        ''' remove last dim 
        - on pascal voc dataset, we does not predict undefined labels '''
