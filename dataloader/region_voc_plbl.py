...
class RegionVOC(region_voc.RegionVOC):
    ...
    def __getitem__(self, index):
        ...
        img_id = img_fname.split('/')[-1].split('.')[0] #.split('/')[-1].split('_leftImg8bit')[0]
