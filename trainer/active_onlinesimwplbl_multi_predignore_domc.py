...
from trainer import active_onlinesimwplbl_multi_predignore
from trainer.active_onlinesimwplbl_multi_predignore import LocalsimWProtoCE
...
class ActiveTrainer(active_onlinesimwplbl_multi_predignore.ActiveTrainer):
