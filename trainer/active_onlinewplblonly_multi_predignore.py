...
class ActiveTrainer(active_onlineplbl_multi_predignore.ActiveTrainer):
    ...
    def get_criterion(self):
        ''' Define criterion '''
        self.joint_local_proto_loss = JointLocalProtoCE(args=self.args, num_superpixel=self.args.nseg, temperature=self.args.group_ce_temp)
    ...
    def train_impl(self, total_itrs, val_period):
        ...
        for iteration in pbar:
            ...
            ### Loss
            joint_local_proto_loss = self.joint_local_proto_loss(preds_plbl, feats_plbl, preds, labels, superpixels, spmasks)
            loss = joint_local_proto_loss
